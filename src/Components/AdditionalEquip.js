...
import {
  FurnitureAdditionalItemsRate,
  SaveEquipmentRental,
  GetEquipmentDetailWithOrderNo,
...
const AdditionalEquip = () => {
  ...
  //     navigate("/");
  //   } else {
  //     FurnitureAdditionalItemsRate().then((res) => {
  //       setAlldata(res.data);
  //     });
  //   }
  // }, []);
  ...
  //       ...data,
  //       qty: data.qty + 1,
  //       totalAmount: (counter + 1) * data.unitCost,
  //       gst: ((counter + 1) * data.unitCost * 18) / 100,
  //       gTotalAmount: (counter + 1) * data.unitCost * 1.18,
  //     });
  ...
  //     toast.warn("Please enter the quantity and Accessories type");
  //   else {
  ...
  //     specification: newdata[0].size_Specification,
  //     itemcode: newdata[0].itemcode,
  //     unitCost:
  //       data.currency === "INR" ? newdata[0].rateINR : newdata[0].rateUSD,
  //     days: 5,
  //   });
  //   setImagepath(newdata[0].representativeImage);
  // };
  // const SaveData = () => {
  //   const Oid = `EQP/${localStorage.getItem(
  //     "user_id"
  ...
  //   setTempdt(list);
  //   tempdt.map((val) => {
  //     SaveEquipmentRental(val).then((res) => {});
  //   });
  ...
  // const SndOrderNo = () => {
  //   GetEquipmentDetailWithOrderNo(orderid).then((res) => {
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
        <div className="container px-lg-4 px-3">
          <div className="justify-content-between align-items-baseline d-flex  flex-lg-row flex-column py-3">
            <h2>Additional Equipment</h2>{" "}
            <Link
              to="/additionalquipmentview"
              className="text-white btn btn-info"
            >
              View Additional Equipment
            </Link>
          </div>
          <Closed/>
          </div>
    ...
    //                 <div class="col-md-7">
    //                   <div class="card-body">
    //                     <h5 class="card-title">Item Code : {data.itemcode}</h5>
    //                     <p class="card-text">
    //                       Size / Specification : {data.specification}
    //                     </p>
    ...
    //                                 `$`
    //                               )}
    //                               {Math.round(x.totalAmount.toFixed(0))}
    //                             </td>
    //                             <td className="text-end">
    //                               {localStorage.getItem("user_country") ===
    //                               "India" ? (
    ...
    //                             `$`
    //                           )}
    //                           {Math.round((x.totalAmount * 18) / 100)}
    //                         </td>
    ...
    //                           )}
    //                           {Math.round(
    //                             (x.totalAmount * 18) / 100 + x.totalAmount
    //                           )}
    //                         </td>
    //                       </tr>
    //                     );
...
export default AdditionalEquip;
