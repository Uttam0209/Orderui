...
const Golf = () => {
  ...
  //           : (counter + 1) * data.unitCost * (counter + 1) * 0.18,
  //       gTotalAmount:
  //         duration === "Entire Event"
  //           ? (counter + 1) * data.unitCost * 1.18
  //           : (counter + 1) * data.unitCost * (counter + 1) * 1.18,
  //     });
  ...
  // const SndOrderNo = () => {
  //   GetGolfDetailsWithOrderNo(orderid).then((res) => {
  ...
  return (
    ...
    //                         allData.map((val, i) => {
    //                           return (
    //                             i==0?<option key={i} value={val.description}>
    //                               {val.description}
    //                             </option>:<></>
    //                           );
    //                         })
