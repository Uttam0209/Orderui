...
const Pantry = () => {
  ...
  // };
  // const SaveData = () => {
  //   const Oid = `PAN/${localStorage.getItem(
  //     "user_id"
  ...
  // const SndOrderNo = () => {
  //   GetPantryDetailsWithOrderNo(orderid).then((res) => {
      ...
      <div className="content-wrapper">
        <div className="container px-lg-5 px-3">
          <div className="justify-content-between  align-items-baseline d-flex py-3">
            <h2>PANTRY</h2>
            <Link to="/pantryview" className="text-white btn btn-info">
              View Pantry
            </Link>
          </div>
          <Closed/>
