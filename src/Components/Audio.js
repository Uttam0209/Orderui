...
const Audio = () => {
  ...
  // };
  // const SaveData = () => {
  //   const Oid = `AUD/${localStorage.getItem(
  //     "user_id"
  ...
  // const SndOrderNo = () => {
  //   GetAudioDetailsWithOrderNo(orderid).then((res) => {});
  // };
  ...
  return (
      ...
      <div className="content-wrapper">
        <div className="container px-lg-5 px-3">
          <div className="justify-content-between  align-items-baseline d-flex py-3">
            <h2>Audio / Visual</h2>
            <Link to="/audioview" className="text-white btn btn-info">
              View Audio / Visual
            </Link>
          </div>
          <Closed/>
    ...
    //                         </div>
    //                       </p>
    //                       {duration !== "Entire Event" && duration !== "" ? (
    //                         <p className="card-text">
    //                           <span>Days :</span>
    //                           <div className="input-group mb-3">
    //                             <span
