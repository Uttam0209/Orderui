...
import {
  GetRatelist,
  SaveTemporaryStaff,
  GetTemporaryDetailsWithOrderNo,
...
const Menpower = () => {
  ...
  //   if (data.qty === 0 || data.particulars === "")
  //     toast.warn("Please enter the quantity and particular");
  //   else {
  //     setTempdt([...tempdt, data]);
  //     setData({ ...data, qty: 0, totalAmount: 0, particulars: "", days: 0 });
  //     setCounter(0);
  //   }
  // };
  ...
  //   setData({
  //     ...data,
  //     particulars: newdata[0].description,
  //     unitCost:
  ...
  // };
  // const SaveData = () => {
  //   const Oid = `MEN/${localStorage.getItem(
  //     "user_id"
  ...
  //   setTempdt(list);
  //   tempdt.map((val) => {
  //     SaveTemporaryStaff(val).then((res) => {
  //       console.log(res);
  //     });
  //   });
  ...
  // const SndOrderNo = () => {
  //   GetTemporaryDetailsWithOrderNo(orderid).then((res) => {
      ...
      <div className="content-wrapper">
        <div className="container px-lg-5 px-0">
          <div className="justify-content-between  align-items-baseline d-flex py-3">
            ...
            <Link to="/menpowerview" className="text-white btn btn-info">
              View Temproary Staff
            </Link>
          </div>
          <Closed/>
          </div>
