...
const Printing = () => {
  ...
  //           ? (counter + 1) * data.unitCost * 5
  //           : (counter + 1) * data.unitCost * 5,
  //       gst:
  //         duration === "Entire Event"
  //           ? (counter + 1) * data.unitCost * 0.18 * 5
  //           : (counter + 1) * data.unitCost * 5 * 0.18,
  //       gTotalAmount:
  //         duration === "Entire Event"
  //           ? (counter + 1) * data.unitCost * 1.18 * 5
  //           : (counter + 1) * data.unitCost * 5 * 1.18,
  //     });
  ...
  //     setData({ ...data, qty: 0, totalAmount: 0, days: 0, description: "" });
  //     setCounter(0);
  //     setCounter1(0);
  //   }
  // };
  ...
  // };
  // const SaveData = () => {
  //   const Oid = `PRI/${localStorage.getItem(
  //     "user_id"
  ...
  // const SndOrderNo = () => {
  //   GetPrintingDetailsWithOrderNo(orderid).then((res) => {
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
        <div className="container px-lg-5 px-3">
          <div className="justify-content-between  align-items-baseline d-flex py-3">
            <h2>Printing</h2>
            <Link to="/printingview" className="text-white btn btn-info">
              View Printing
            </Link>
          </div>
          <Closed/>
      ...
      //               <table className="table w-50" style={{ boxShadow: "none" }}>
      //                 <thead>
      //                   <tr>
      //                     <th>Total</th>
      ...
      //                 <td>4</td>
      //                 <td>
      //                   Name & Address of the Bank Branch (where payments are to
      //                   be sent by PCRA)
      //                 </td>
      //                 <td>
